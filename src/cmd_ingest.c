...
int cmd_ingest(int argc, char **argv) {
    ...
    snprintf(
        msg,
        sizeof(msg),
        "root=%.240s files=%llu images=%llu pdfs=%llu article2assets=%llu comic2panel=%llu image_core=%llu skipped=%llu dry_run=%d duration_ms=%.3f",
        plan.root,
        plan.files_seen,
        plan.images_found,
        plan.pdfs_found,
